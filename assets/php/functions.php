...
{
    $lang = getLangFromFolder();
    $site_url = 'https://capiturex.co';
    $site_name = 'CapitureX';
    $author_name = 'CapitureX Team';
    $logo_path = '/assets/images/icon-180.8841d063c0.png';
    $dashboard_image = '/assets/images/icon-180.8841d063c0.png'; // Единое изображение для всех страниц
