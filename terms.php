  ...
  <body>
    ...
    <main>
      ...
      <article class="page__section">
        <section id="general" class="por-article-section">
          <div class="page__section-content por-article-section__content">
            ...
            <p class="page__section-description paragraph-text underlined-links por-article-section__description">
              <?php echo getLang('terms__general_text_1'); ?>
            </p>
            <ul role="list" class="portfolio__article-section--list">
              <li class="por-article-section__list-item">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_1'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_2'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_3'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_4'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_5'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_6'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_7'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_8'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_9'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div>
                  <?php echo getLang('terms__general_listitem_10'); ?>
                </div>
              </li>
              <li class="por-article-section__list-item">
                <span role="img" aria-hidden="true" class="icon icon--medium icon--accent por-article-section__list-item-icon">
                ...
                <div><?php echo getLang('terms__general_listitem_11'); ?></div>
              </li>
            </ul>
          </div>
        </section>

        <section id="accepting-terms" class="por-article-section">
          <div class="page__section-content por-article-section__content">
            <h3 class="page__section-title">
              <?php echo getLang('terms__accepting_terms_title'); ?>
            </h3>
            <p class="page__section-description paragraph-text underlined-links por-article-section__description">
              <?php echo getLang('terms__accepting_terms_text_1'); ?>
            </p>
          </div>
        </section>
      </article>
